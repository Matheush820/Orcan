...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Orçan.Api.Models.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Orçan.Core.Models.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Orçan.Core.Models.Transaction", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<long>", b =>
                {
                    b.HasOne("Orçan.Api.Models.User", null)
                        .WithMany("Roles")
            ...
            modelBuilder.Entity("Orçan.Core.Models.Transaction", b =>
                {
                    b.HasOne("Orçan.Core.Models.Category", "Category")
                        .WithMany()
